...
function Hero() {
  return (
    ...
    >
      ...
      <Link
        to="/contact"
        className="bg-sky-600 hover:bg-neutral-50 hover:cursor-pointer mt-6 py-4 px-9 z-10 shadow-lg transition-all duration-300 ease-in-out transform hover:scale-115"
      >
        <p className="text-center text-base font-semibold text-neutral-50 hover:text-sky-600 ">
          Let's Connect
        </p>
      </Link>
    </div>
